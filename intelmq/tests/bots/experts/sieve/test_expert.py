...
class TestSieveExpertBot(test.BotTestCase, unittest.TestCase):
    ...
    def test_if_clause(self):
        ...
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__), "test_sieve_files/test_if_clause.sieve"
        )
    ...
    def test_if_else_clause(self):
        ...
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__), "test_sieve_files/test_if_else_clause.sieve"
        )
    ...
    def test_if_elif_clause(self):
        ...
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__), "test_sieve_files/test_if_elif_clause.sieve"
        )
    ...
    def test_if_elif_else_clause(self):
        ...
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__), "test_sieve_files/test_if_elif_else_clause.sieve"
        )
    ...
    def test_or_match(self):
        ...
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__), "test_sieve_files/test_or_match.sieve"
        )
    ...
    def test_and_match(self):
        ...
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__), "test_sieve_files/test_and_match.sieve"
        )
    ...
    def test_precedence(self):
        ...
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__), "test_sieve_files/test_precedence.sieve"
        )
    ...
    def test_string_equal_match(self):
        """Test == string match"""
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__), "test_sieve_files/test_string_equal_match.sieve"
        )
    ...
    def test_string_regex_match(self):
        """Test =~ string match"""
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__), "test_sieve_files/test_string_regex_match.sieve"
        )
    ...
    def test_numeric_equal_match(self):
        """Test == numeric match"""
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__), "test_sieve_files/test_numeric_equal_match.sieve"
        )
    ...
    def test_numeric_invalid_key(self):
        ...
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__), "test_sieve_files/test_numeric_invalid_key.sieve"
        )
    ...
    def test_exists_match(self):
        """Test :exists match"""
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__), "test_sieve_files/test_exists_match.sieve"
        )
    ...
    def test_not_exists_match(self):
        ...
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__), "test_sieve_files/test_notexists_match.sieve"
        )
    ...
    def test_drop_event(self):
        ...
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__), "test_sieve_files/test_drop_event.sieve"
        )
    ...
    def test_keep_event(self):
        ...
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__), "test_sieve_files/test_keep_event.sieve"
        )
    ...
    def test_add(self):
        ...
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__), "test_sieve_files/test_add.sieve"
        )
    ...
    def test_add_force(self):
        ...
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__), "test_sieve_files/test_add_force.sieve"
        )
    ...
    def test_update(self):
        ...
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__), "test_sieve_files/test_update.sieve"
        )
    ...
    def test_remove(self):
        """Test removing keys"""
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__), "test_sieve_files/test_remove.sieve"
        )
    ...
    def test_multiple_actions(self):
        ...
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__), "test_sieve_files/test_multiple_actions.sieve"
        )
    ...
    def test_ip_range_match(self):
        ...
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__), "test_sieve_files/test_ip_range_match.sieve"
        )
        ...
        self.assertLogMatches(
            pattern="^Could not parse IP address", levelname="WARNING"
        )
        self.assertMessageEqual(0, event)
    ...
    def test_ip_range_list_match(self):
        ...
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__), "test_sieve_files/test_ip_range_list_match.sieve"
        )
    ...
    def test_date_match(self):
        ...
        self.sysconfig["file"] = (
            Path(__file__).parent / "test_sieve_files/test_date_match.sieve"
        )
        ...
        event["time.observation"] = (
            "2023-06-01"  # just date, neither before nor after the date's midnight
        )
    ...
    def test_comments(self):
        ...
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__), "test_sieve_files/test_comments.sieve"
        )
    ...
    def test_named_queues(self):
        """Test named queues"""
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__), "test_sieve_files/test_named_queues.sieve"
        )
    ...
    def test_numeric_key(self):
        """Test == numeric match"""
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__), "test_sieve_files/test_numeric_key.sieve"
        )
    ...
    def test_parentheses(self):
        ...
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__), "test_sieve_files/test_parentheses.sieve"
        )
    ...
    def test_basic_math(self):
        ...
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__), "test_sieve_files/test_basic_math.sieve"
        )
    ...
    def test_multiple_paths(self):
        ...
        self.prepare_bot(
            destination_queues={"_default", "one", "two"},
            parameters={
                "file": os.path.join(
                    os.path.dirname(__file__),
    ...
    def test_only_one_action(self):
        ...
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__), "test_sieve_files/test_only_one_action.sieve"
        )
    ...
    def test_list_equals_match(self):
        ...
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__), "test_sieve_files/test_list_equals_match.sieve"
        )
    ...
    def test_list_setequals_match(self):
        ...
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__),
            "test_sieve_files/test_list_setequals_match.sieve",
        )
    ...
    def test_list_overlaps_match(self):
        ...
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__), "test_sieve_files/test_list_overlaps_match.sieve"
        )
    ...
    def test_list_subsetof_match(self):
        ...
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__), "test_sieve_files/test_list_subsetof_match.sieve"
        )
    ...
    def test_list_supersetof_match(self):
        ...
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__),
            "test_sieve_files/test_list_supersetof_match.sieve",
        )
    ...
    def test_bool_match(self):
        """Test bool match"""
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__), "test_sieve_files/test_bool_match.sieve"
        )
        base = EXAMPLE_INPUT.copy()
    ...
    def test_typed_values(self):
        """Test typed values"""
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__), "test_sieve_files/test_typed_values.sieve"
        )
    ...
    def test_append(self):
        """Test append action"""
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__), "test_sieve_files/test_append.sieve"
        )
    ...
    def test_force_append(self):
        ...
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__), "test_sieve_files/test_force_append.sieve"
        )
    ...
    def test_negation(self):
        ...
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__), "test_sieve_files/test_negation.sieve"
        )
    ...
    def test_nested_if(self):
        ...
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__), "test_sieve_files/test_nested_if.sieve"
        )
    ...
    def test_mixed_if_and_actions(self):
        ...
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__), "test_sieve_files/test_mixed_if.sieve"
        )
    ...
    def test_empty_list(self):
        ...
        self.sysconfig["file"] = os.path.join(
            os.path.dirname(__file__), "test_sieve_files/test_empty_list.sieve"
        )
